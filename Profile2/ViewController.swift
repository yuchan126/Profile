...
class ViewController: UIViewController {
    ...
    @IBAction func tapButton1(){
        ...
        profilaImageView.image = UIImage(named: "philImage")
    ...
    @IBAction func tapButton2(){
        ...
        profilaImageView.image = UIImage(named:"trackImage")
    ...
    @IBAction func tapButton3(){
        ...
        profilaImageView.image = UIImage(named:"appleImage")
    ...
    @IBAction func tapButton4(){
        ...
        profilaImageView.image = UIImage(named:"flightImage")
